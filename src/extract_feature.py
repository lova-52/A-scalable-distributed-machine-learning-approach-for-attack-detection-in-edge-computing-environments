...
df = pd.read_excel('C:/Repo/ELM_IDS/CTU-13-Dataset/8/capture20110816-3_no_empty_rows.xlsx')
...
output_feature_vectors_excel_file = 'C:/Repo/ELM_IDS/CTU-13-Dataset/8/feature_vectors_2.xlsx'
